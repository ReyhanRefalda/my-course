                ...
                @if ($transactions->isEmpty())
                    <div class="text-center text-gray-500 py-8">
                        <div class="col-12 text-center flex justify-center">
                            <img src="{{ asset('assets/images/background/no-data.jpg') }}" alt="No Data" class="img-fluid" style="width: clamp(150px, 50vw, 300px);">
                        </div>
                            ...
                            @foreach ($transactions as $transaction)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-4 flex items-center gap-4">
                                        <img src="{{ Storage::url($transaction->thumbnail) }}" alt="Thumbnail" class="w-12 h-12 rounded-lg object-cover">
                                        <div>
                                    ...
                                    <td class="px-2 py-2 text-right">
                                        <a href="{{ route('admin.subscribe_transactions.show', $transaction) }}" class="font-bold py-2 px-3 text-white rounded-full shadow bg-[#3525B3] hover:bg-[#281a8b] text-sm">
                                            View Details
                                        </a>
                                    </td>
                                </tr>
