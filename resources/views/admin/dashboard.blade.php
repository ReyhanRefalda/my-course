<x-app-layout>
    ...
    {{-- <div class="py-12"> --}}
    <div class="">
        <div class="overflow-hidden shadow-sm sm:rounded-xl flex flex-col">
            {{-- <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl p-10 flex flex-col gap-y-5"> --}}
            @role('owner')
                <div class="flex flex-col gap-10 md:flex-row justify-between items-center">
                    <div class="flex gap-14 card px-12 py-4">
                        <div>
                            <h3 class="text-indigo-950 text-xl ">Transactions</h3>
                    ...
                    <div class="flex gap-14 card px-12 py-4">
                        <div>
                            <h3 class="text-indigo-950 text-xl ">Students</h3>
                        ...
                        <svg width="60" height="60" viewBox="0 0 24 24" fill="none"
                            ...
                            <path opacity="0.4"
                                ...
                                fill="#292D32" />
                            <path
                                d="M21.9902 16.5899C21.9102 17.5599 21.2902 18.3999 20.2502 18.9699C19.2502 19.5199 17.9902 19.7799 16.7402 19.7499C17.6002 19.0999 17.8802 18.2899 17.9602 17.4299C18.0602 16.1899 17.4702 14.9999 16.2902 14.0499C15.6202 13.5199 14.8402 13.0999 13.9902 12.7899C16.2002 12.1499 18.9802 12.5799 20.6902 13.9599C21.6102 14.6999 22.0802 15.6299 21.9902 16.5899Z"
                                fill="#292D32" />
                        </svg>
                    </div>
                    <div class="flex gap-14 card px-12 py-4">
                        <div>
                            <h3 class="text-indigo-950 text-xl ">Teachers</h3>
