...
<div>
    <div class="mb-2 min-h-[340px] overflow-hidden [border-bottom:1px_solid_#424242]">
        ...
        <div class="h-[150px] flex flex-col justify-between p-2 overflow-y-hidden">
            <a href="{{ $link }}" class="hover:underline text-[#181818] text[1.3rem] font-bold">
                <h3 class="text-[1.3rem] font-bold">{{ $title }}</h3>
            </a>
            <div class="flex justify-between">
                <p class="text-sm text-gray-600 font-semibold">By {{ $user }}</p>
