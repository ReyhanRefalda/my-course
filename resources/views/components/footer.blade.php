<footer class="max-w-[1200px] mx-auto flex flex-col pt-[70px] pb-[50px] px-[100px] gap-[50px] bg-[#F5F8FA] rounded-[32px]">
    <div class="flex justify-between">
        <a href="">
            <div>
                <img src="{{asset('assets/logo/logo-black.png')}}" alt="logo" style="width: 200px; height: auto;  margin-left: 15px;">
            </div>
        </a>
    ...
    <div class="w-full h-[51px] flex items-end border-t border-[#E7EEF2]">
        <p class="mx-auto text-sm text-[#6D7786] -tracking-[2%]">All Rights Reserved My Course Rayhan & Friends 2024</p>
    </div>
</footer>
