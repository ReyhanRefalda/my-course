<x-user>
    <main class="pt-4 pb-16 lg:pt-4 lg:pb-24 antialiased">
        ...
        {{-- social media --}}
        <div
            class="mx-8 px-6 py-3 rounded-lg flex justify-between items-center leading-[170%] bg-gradient-to-r from-[#3525B3] to-[#1c1268]">
        ...
        <div
            ...
            <article
                ...
                {{-- social media --}}
                <div
                    class="mx-8 px-6 py-3 rounded-lg flex justify-between items-center leading-[170%] bg-gradient-to-r
                    from-[#3525B3] to-[#1c1268]">
                    <div class="flex flex-col items-center justify-center w-full">
                        <h3 class="m-0 p-0 text-[12px] font-semibold text-[#f7f9fa] [letter-spacing:1px;]">FOLLOW US FOR
                            THE LATEST NEWS</h3>
