...
<body class="font-poppins text-[#0E0140]">
    <main class="min-h-screen flex">
        <div id="Left-background" class="fixed top-0 left-0 h-screen w-[640px] flex shrink-0 items-baseline ring-1 ring-[#E8E4F8] overflow-hidden">
            <img src="{{asset('assets/background/benefit_illustration.png')}}" class="background object-cover w-full h-full" alt="background image">
        </div>png
        <section id="Signup-form" class="pl-[640px] flex flex-col py-[140px] items-center justify-center w-full gap-[70px]">
            @if ($errors->any())
                <div class="py-3 px-4 w-[500px] mb-5 text-center rounded-3xl bg-red-600 text-black border border-red-700">
                    {{$errors->first()}}
                </div>
             @endif
            <form action="{{route('register')}}" method="POST" class="max-w-[500px] w-full flex flex-col gap-[30px]" enctype="multipart/form-data">
                @csrf
                <a href="{{route('front.index')}}" class="logo h-[10] flex shrink-0 justify-start mb-10">
                    <img src="{{asset('assets/logo/logo-black.png')}}" class="object-contain" alt="logo" style="width: 200px; height: auto;">
                </a>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center rounded-full p-[14px_24px] gap-[10px] ring-1 ring-[#0E0140] focus-within:ring-2 focus-within:ring-[#FF6B2C] transition-all duration-300">
                        ...
                        <input type="text" id="Name" name="name" autocomplete="off" class="appearance-none w-full outline-none font-semibold placeholder:font-normal placeholder:text-[#0E0140] focus:outline-none" placeholder="Write your full name" >
                    </div>
                </div>
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center rounded-full p-[14px_24px] gap-[10px] ring-1 ring-[#0E0140] focus-within:ring-2 focus-within:ring-[#FF6B2C] transition-all duration-300">
                        ...
                        <input type="email" id="Email" name="email" autocomplete="off" class="appearance-none w-full outline-none font-semibold placeholder:font-normal placeholder:text-[#0E0140] focus:outline-none" placeholder="Write your email address" >
                    </div>
                </div>
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center rounded-full p-[14px_24px] gap-[10px] ring-1 ring-[#0E0140] focus-within:ring-2 focus-within:ring-[#FF6B2C] transition-all duration-300">
                        ...
                        <input type="text" id="Occupation" name="occupation" autocomplete="off" class="appearance-none w-full outline-none font-semibold placeholder:font-normal placeholder:text-[#0E0140] focus:outline-none" placeholder="Type here..." >
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center rounded-full p-[14px_24px] gap-[10px] ring-1 ring-[#0E0140] focus-within:ring-2 focus-within:ring-[#FF6B2C] transition-all duration-300">
                        ...
                        <input type="password" id="Password" name="password" autocomplete="off" class="appearance-none w-full outline-none font-semibold placeholder:font-normal placeholder:text-[#0E0140] focus:outline-none" placeholder="Write your password" >
                    </div>
                </div>
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center rounded-full p-[14px_24px] gap-[10px] ring-1 ring-[#0E0140] focus-within:ring-2 focus-within:ring-[#FF6B2C] transition-all duration-300">
                        ...
                        <input type="password" id="Confirm-Password" name="password_confirmation" autocomplete="off" class="appearance-none w-full outline-none font-semibold placeholder:font-normal placeholder:text-[#0E0140] focus:outline-none" placeholder="Write your password" >
                    </div>
                </div>
                <div class="flex flex-col gap-2">
                    ...
                    <div class="grid grid-cols-2 gap-[30px]">
                        <label class="relative group bg-white rounded-3xl p-[30px_24px] flex flex-col items-center justify-center gap-5 ring-1 ring-[#0E0140] has-[:checked]:ring-2 has-[:checked]:ring-[#FF6B2C] transition-all duration-300">
                            ...
                            <img src="assets/icon/tick-circle-orange.svg" class="absolute top-[10px] right-[10px] w-6 h-6 opacity-0 group-has-[:checked]:opacity-100 transition-all duration-300" alt="icon">
                            <input type="radio" name="account_type" id="Employee" class="absolute -z-10 top-1/2 left-1/2" value="Employee" >
                        </label>
                        <label class="relative group bg-white rounded-3xl p-[30px_24px] flex flex-col items-center justify-center gap-5 ring-1 ring-[#0E0140] has-[:checked]:ring-2 has-[:checked]:ring-[#FF6B2C] transition-all duration-300">
                            <div class="w-[46px] h-[46px] flex shrink-0">
                                <img src="{{asset('assets/icon/avatar-group.png')}}" alt="icon">
                            </div>
                            <p class="font-semibold">As an Employer</p>
                            <img src="assets/icon/tick-circle-orange.svg" class="absolute top-[10px] right-[10px] w-6 h-6 opacity-0 group-has-[:checked]:opacity-100 transition-all duration-300" alt="icon">
                            <input type="radio" name="account_type" id="Employer" class="absolute -z-10 top-1/2 left-1/2" value="Employer" >
                        </label>
                    </div>
                </div>
