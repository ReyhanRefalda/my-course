    ...
    <div class="mt-16 mx-8 overflow-hidden flex justify-center items-center">
        <div class="grid [grid-template-columns:1fr_1fr;]">
            ...
            <div class="w-full h-full flex justify-center items-center">
                <img src="{{ isset($rejection_reason) && $rejection_reason ? asset('assets/images/background/rejected.jpg') : asset('assets/images/background/approved.png') }}"
            ...
            <div class="h-full flex flex-col justify-center items-start">
                ...
                <p class="text-gray-600 text-lg mb-6">
                    @if (isset($rejection_reason) && $rejection_reason)
                        <span class="text-red-700 font-semibold">Reason for Rejection:</span> {{ $rejection_reason }}
                    @else
